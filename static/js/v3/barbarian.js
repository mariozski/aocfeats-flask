...
new Feat(123400, 1, 2, 5, 2, 5, null,
    new FeatDescription('Devastation',
          [],
          "Attacks with the barbarian's primary weapon have a chance of increasing the barbarian's Critical Rating for a short period of time. This effect can stack up to ten times. Investing feat points increases the chance of applying the Critical Rating increase.")),
...
new Feat(123500, 1, 3, 6, 6, 1, null,
    new FeatDescription('Paralysis',
          [{s:['-'], suf:'', t:'Physical Wrack on target'}],
...
new Feat(122600, 1, 4, 2, 7, 3, null,
    new FeatDescription('Ability - Eyes of Madness',
          [{s:[1600,2300,3000], suf:'', t:'Armor Penetration'}],
          "Grants the barbarian an ability that allows them to spot a gap in the enemy's armor, increasing armor penetration significantly for 5 seconds. Investing feat points increases armor penetration gained.")),
...
new Feat(124600, 1, 6, 5, 15, 5, null,
    new FeatDescription("Ability - Swarm Fighter",
         ...
         "Grants the barbarian an ability that applies a damage over time effect on the 6 closest targets within 5 meters. With each target hit, the barbarian is invigorated, causing a minor heal effect on the barbarian. Investing points into Swarm Fighter increases the damage component of the damage over time effect. This feat also passively increases the damage the barbarian inflicts.")),
...
new Feat(124000, 1, 8, 5, 22, 5, [7,5],
    new FeatDescription("Combo - Decapitation",
         [{s:[0,12.5,25,37.5,50], suf:'%', t:"Increase to Damage Per Second on Decapitation"}],
