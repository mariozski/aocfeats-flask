...
return function() {
 return {
    ...
    new Feat(241800, 2, 6, 1, 22, 3, null,
        new FeatDescription('Circling Wolves',
            [],
            "Expands the Lycanthropic Bite spell by placing a lesser lifetap effect on the Bear Shaman's teammates. Investing feat points increases the potency of the lifetap given to teammates.")),
    ...
    new Feat(242100, 2, 9, 5, 24, 1, [8,5],
        new FeatDescription('Spell - Booming Roar',
            [],
            "Grants the shaman an instant-cast spell that summons Companion Spirit and silences all foes near the target, interrupting combos in progress and preventing spell casting for a short period of time."))
