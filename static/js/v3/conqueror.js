...
new Feat(57800, 2, 2, 5, 56, 2, null,
    new FeatDescription("Ability - Retaliation",
    	   [],
    	   "Grants the conqueror an ability which generates a high amount of threat on the closest four enemies. For a short time afterward, any enemies attacking the conqueror will be damaged (PVP - once every second on one player). Investing another feat point increases the power of this damage shield.")),
...
new Feat(54000, 2, 4, 5, 38, 1, null,
    new FeatDescription("Ability - Burst of Aggression",
    	   [],
    	   "This ability knocks away enemies in an area around the conqueror. For a short time after use, all attacks will generate 10% more hate.<br/><br/>The knock back effect will not apply to crows control combos. If the target of the knockback is a player, the Conqueror will receive the Fighting Spirit effect, which will also prevent them from triggering their knockback element of Burst of Aggression for the duration.")),
...
new Feat(53500, 2, 9, 2, 54, 1, [8,2],
    new FeatDescription("Ability - Overcome the Odds",
    	   [],
    	   "Grants an ability that causes physical attacks to heal the conqueror and applies the Fighting Spirit effect. When activated, this ability refreshes the cooldown on the Retaliation ability. This ability cannot be activated if Fighting Spirit is currently active. Forces conqueror to switch to defensive stance for the duration.")),
new Feat(54800, 2, 9, 5, 55, 1, [8,5],
    new FeatDescription("Ability - Blessed Conquest",
    	   [],
    	   "Grants the conqueror an ability that makes them invulnerable for a brief time and applies the Fighting Spirit effect. This ability cannot be activated if Fighting Spirit is currently active. Forces conqueror to switch to defensive stance for the duration."))
]}};
