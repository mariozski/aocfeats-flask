...
new Feat(54000, 2, 4, 5, 38, 1, null,
    new FeatDescription("Ability - Burst of Aggression",
    	   [],
    	   "This ability knocks away enemies in an area around the conqueror. For a short time after use, all attacks will generate 10% more hate.<br/><br/>The knock back effect will not apply to crows control combos. Applies fighting spirit for few seconds. The knockback element of Burst of Aggression now only triggers on players when fighting spirit is not running.")),
