...
return function() {
 return {
            treeNames: ["Depravity", "Desecration"],
            id: "11f",
            feats: [
...
new Feat(74700, 1, 7, 5, 24, 5, null,
    new FeatDescription("Cabalistic Hunger",
    	...
    	"Converts part of the damage inflicted by spells into life for the dark templar. Also, Leech Life combos has a 20/40/60/80/100% chance of creating a Zone of Gluttony when used.")),
