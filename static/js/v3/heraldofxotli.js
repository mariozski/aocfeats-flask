...
new Feat(115400, 1, 4, 1, 6, 3, null,
    new FeatDescription("Demonic Strength",
    	   [],
    	   "The herald's demonic forms are strengthened even further, increasing melee weapon damage while in any demonic form. Points invested into this feat further increase the melee weapon damage bonus.")),
...
new Feat(112800, 2, 3, 3, 34, 2, null,
    new FeatDescription("Improved Word of Command",
    	   [{s:[-25,-50],suf:'%',t:"Decrease casting time"},
           {s:[1,2],suf:'m',t:"Radius on Word of Command"}],
    	   "Increases the area affected by Word of Command, and reduces the casting time of that spell.")),
...
new Feat(113000, 2, 4, 6, 38, 3, null,
    new FeatDescription("Roots of Hell",
    	   [{s:[25,50, 75],suf:'%',t:"Knockback Resistance"}],
    	   "Increases the herald's resistance to knockback effects when in any demon form.")),
...
new Feat(113300, 2, 6, 1, 43, 5, [6,2],
    new FeatDescription("Improved Phoenix Cloak",
    	   [{s:[20,40,60,80,100],suf:'%',t:"Duration on Phoenix Cloak"}],
    	   "Augments the Phoenix Cloak spell by increasing the duration of the buff. Each feat point spent increases the duration by 20%.")),
new Feat(113200, 2, 6, 2, 44, 3, null,
    new FeatDescription("Phoenix Wings",
    	   [],
    	   "Increases the movement speed bonus of the Phoenix Cloak spell by 5% per rank")),
...
new Feat(114200, 2, 6, 5, 46, 3, null,
    new FeatDescription("Horrible Visage of Xotli",
    	   [],
    	   "Increases the duration of the stun effect on enemies from transforming into a demon form, (Desecrating Essence and Avatar of Xotli), by 33% per feat point spent.")),
