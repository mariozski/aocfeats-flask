...
return  function() {
 return {
            treeNames: ["Reanimation", "Nightfall"],
            id: "129",
            feats: [
...
new Feat(80800, 1, 6, 2, 17, 1, null,
    new FeatDescription("Necrotic Pustule",
    	   [{s:[-0.2], suf:'s', t:"Decrease to casting time on Flesh to Worms"}],
    	   "Lowers the casting time for the Flesh to Worms spell. Also, when the undead minion Necrotic Bomb explodes it leaves behind a corpse that pulses nearby enemies with unholy damage.")),
